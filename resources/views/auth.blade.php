...
<head>
    ...
    <title>EShop Website - Admin Verification</title>
    <!-- Favicon icon -->
                            ...
                            <div class="card-body pt-5">
                                ...
                                <form method="POST" class="mt-5 mb-5 login-input" action="{{ URL::to('auth') }}">
                                    ...
                                    <div class="form-group">
                                        <input id="envato_username" type="text" class="form-control @error('envato_username') is-invalid @enderror" name="envato_username" required autocomplete="envato_username" autofocus placeholder="Envato Username">
