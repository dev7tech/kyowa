...
var WorkspaceAdd = function() {
    var workspace = function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.result === "success") {
                        localStorage.setItem('currentWorkspaceId', response.workspace.id);
        ...
        descriptionForm.on('submit', function(e) {
            ...
            var workspaceId = localStorage.getItem('currentWorkspaceId');
            if (workspaceId === "null") {
        ...
        $('#workspace_photo_add_btn').on('click', function(e) {
            e.preventDefault();
            var workspaceId = localStorage.getItem('currentWorkspaceId');
            if (workspaceId === "null") {
                localStorage.setItem("isPassStep_1", "false");
            ...
            PhotoSlimForm.find('input[name=workspace_id]').val(workspaceId);

            $('#workspace_main_slim_image_modal').modal('show');
        });
        ...
        locationSetForm.on('submit', function(e) {
            ...
            locationSetForm.find('input[name=workspace_id]').val(workspaceId);
        ...
        amenityForm.on('submit', function(e) {
            ...
            amenityForm.find('input[name=workspace_id]').val(workspaceId);
        ...
        pricingForm.on('submit', function(e) {
            ...
            pricingForm.find('input[name=workspace_id]').val(workspaceId);
