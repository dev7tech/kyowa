...
function blogNormallTextInput(count) {
    var textInputBox = '\
        ...
        <textarea class="form-control m-input m-input--air blog-text-input normall" name="blog_text" data-order="'+count+'" data-document_id="null" data-text_type="0" rows="4" required></textarea>\
...
function blogBoldTextInput(count) {
    var textInputBox = '\
        ...
        <div class="col-12" style="position: relative;">\
        <a class="blog-content-remove-btn" ><i class="la la-remove" ></i></a>\
        <textarea class="form-control m-input m-input--air blog-text-input bold" name="blog_text" data-order="'+count+'" data-document_id="null" data-text_type="1" rows="4" required></textarea>\
        <a class="blog_content_add_after_this_btn" data-count_order="'+count+'"><i class="la la-plus" ></i></a>\
        </div>\
        </div>\
        ';
...
function blogItalicTextInput(count) {
    var textInputBox = '\
        ...
        <div class="col-12" style="position: relative;">\
        <a class="blog-content-remove-btn" ><i class="la la-remove" ></i></a>\
        <textarea class="form-control m-input m-input--air blog-text-input italic" name="blog_text" data-order="'+count+'" data-document_id="null" data-text_type="2" rows="4" required></textarea>\
        <a class="blog_content_add_after_this_btn" data-count_order="'+count+'"><i class="la la-plus" ></i></a>\
        </div>\
        </div>\
        ';
        ...
        $('#new-blog-post-form').submit(function(e) {
            ...
            form.find('div.blog-content').each(function() {
                ...
                if (singleTextContent.length > 0) {
                    ...
                    var blogDocumentId = singleTextContent.data('document_id');
                    var contentType = "text";
                    var contentValue = singleTextContent.val();
                    var textType = singleTextContent.data('text_type');

                    var textContent = {"order": blogOrder, "type": contentType, "textType": textType, "value": contentValue, 'document_id': blogDocumentId};
            ...
            if (requestArray.length > 0) {
                ...
                var blog_id = form.find('#blog_id_for_edit').val();
