...
var PropertyAdd = function() {
    var property = function() {
        var givenLat = $('#property_lat').val();
        givenLat = Number(givenLat);
        var givenLng = $('#property_lng').val();
        ...
        descriptionForm.find('.form-submit-btn').on('click', function(e) {
            ...
            if (requestArray.length > 0) {
                ...
                var PropertyId = descriptionForm.find('input[name=property_id]').val();
                ...
                success: function(response) {
                    ...
                    if (response.result === "success") {
                        var imageSelectedForm = '\
                                                ...
                                                <input type="radio" name="property_main_header_photo" value="'+response.image_id+'">\
                                                <span></span>\
                                                </label>\
    ...
    var initLocalStorage = function() {
        ...
        localStorage.setItem('isPassStep_8', "true");
        localStorage.setItem('isPassStep_9', "true");
        localStorage.setItem('isPassStep_10', "true");
    }
