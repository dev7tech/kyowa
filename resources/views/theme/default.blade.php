...
<head>
    ...
    <link href="{!! asset('public/assets/css/style.css?r=4') !!}" rel="stylesheet">
    <link href="{{asset('public/css/w3.css')}}" rel="stylesheet" type="text/css" />
    ...
    ********************-->
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright &copy; Designed & Developed by 2022</p>
            </div>
        </div>
        <!--**********************************
            Footer end
    ...
    <script type="text/javascript">
        ...
        $('select[name=category_table_length]').on('change', function() {
            var id = $(this).val();
            localStorage.setItem('pagination', id);
        });
    </script>
    <script type="text/javascript">
