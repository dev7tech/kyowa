...
<link href="{{asset('public/assets/plugins/loader.css')}}" rel="stylesheet" type="text/css" />
...
<div class="m-portlet m-portlet--mobile m-portlet-chat">
    ...
    <div class="chat-portlet-chat-form-container" id="chat-portlet-chat-form-container">
        @include('theme.messenger', ['conversation' => $singleConv])
    </div>
</div>
